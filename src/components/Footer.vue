    ...
    <div class="container">
      <div class="left">
        <div class="col-1">
          ...
          <ul>
            <li>
              <a href="#"><i class="bx bx-youtube svg-icon"></i></a>
            </li>
            <li>
              <a href="#"><i class="bx bx-twitter svg-icon"></i></a>
            </li>
            <li>
              <a href="#"><i class="bx bx-instagram svg-icon"></i></a>
            </li>
            <li>
              <a href="#"><i class="bx bx-linkedin svg-icon"></i></a>
            </li>
          </ul>
        </div>
        <div class="col-2">
